...
install -D -m 0644 packaging/zarafa.php %{buildroot}/var/clearos/openldap_directory/extensions/30_zarafa.php
...
/var/clearos/openldap_directory/extensions/30_zarafa.php
